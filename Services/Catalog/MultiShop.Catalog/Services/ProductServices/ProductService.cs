...
public class ProductService : IProductService
{
    ...
    public ProductService(IMapper mapper, IDatabaseSettings _datebaseSettings)
    {
        ...
        _productCollection = database.GetCollection<Product>(_datebaseSettings.ProductCollectionName);
        _mapper = mapper;
    }
