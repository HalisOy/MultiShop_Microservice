...
public class CategoryService : ICategoryService
{
    ...
    public CategoryService(IMapper mapper, IDatabaseSettings _datebaseSettings)
    {
        ...
        _categoryCollection = database.GetCollection<Category>(_datebaseSettings.CategoryCollectionName);
        _mapper = mapper;
    }
